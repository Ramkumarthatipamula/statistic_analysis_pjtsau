...
class StatisticsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create statistic" do
    assert_difference('Statistic.count') do
      post statistics_url, params: { statistic: { analytical_type: @statistic.analytical_type, no_of_samples: @statistic.no_of_samples, no_of_treatments: @statistic.no_of_treatments } }
    end
  ...
  test "should update statistic" do
    patch statistic_url(@statistic), params: { statistic: { analytical_type: @statistic.analytical_type, no_of_samples: @statistic.no_of_samples, no_of_treatments: @statistic.no_of_treatments } }
